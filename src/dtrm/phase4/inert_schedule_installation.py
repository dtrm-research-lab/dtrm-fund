...
def expected_statement() -> JsonObject:
    return {
        ...
        "pre_activation_guards": {
            ...
            "scheduled_rerun_target_must_retain_original": True,
            "scheduled_rerun_target_derivation_from_rerun_clock_permitted": False,
            "scheduled_rerun_side_effects_permitted_without_original_target_provenance": False,
            "scheduled_rerun_attempt1_record_must_be_immutable": True,
            "scheduled_rerun_run_id_must_equal_attempt1": True,
            "scheduled_rerun_slot_must_equal_attempt1": True,
            "scheduled_rerun_target_at_utc_must_equal_attempt1": True,
            "scheduled_rerun_cron_must_equal_attempt1": True,
            "scheduled_rerun_workflow_path_must_equal_attempt1": True,
            "scheduled_rerun_workflow_identity_must_equal_attempt1": True,
